...
function wpestate_checking_theme_code(){
    jQuery('#wpestate_check_ajax_license').on('click',function(){
        ...
        var license_ajax_nonce      = jQuery('#wprentals_activate_license_nonce').val();
        var register_email          = jQuery('#wpestate_register_email').val();


        if(wpestate_envato_username=='' || wpestate_envato_code=='' || register_email==''  ){
        ...
        if (!emailPattern.test(register_email)) {
            jQuery('#wpestate_register_license_notification').empty().text('Please use a valid email address');
            return;
        } 
        ...
        jQuery.ajax({
            ...
            success: function (data) {     
                ...
                jQuery('#wpestate_register_email').val('');
